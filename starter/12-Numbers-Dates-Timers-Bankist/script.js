...
const account1 = {
  ...
  movementsDates: [
    ...
    '2025-07-31T17:01:17.194Z',
    '2025-08-01T23:36:17.929Z',
    '2025-08-02T10:51:36.790Z',
  ],
  currency: 'EUR',
  locale: 'pt-PT', // de-DE
};
...
console.log(new Date('Aug 02 2025 12:35:24'));
...
console.log(future.getTime()); // calculating ms(milisecond)
