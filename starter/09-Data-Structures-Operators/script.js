...
console.log(maskCreditCard(123123123123123123123));
console.log(maskCreditCard('232323232323232'));
...
console.log(annountcement.replace('door', 'gate'));
...
checkBaggage('I have a laptop, some of Food and a pocket Knife');
...
console.log('' || 'Jonas');
console.log(true || 0);
console.log(undefined || null); // ikisi de falsy değer o zaman sonuncusu döner.
...
console.log('--------AND----------');
console.log(0 && 'Jonas');
console.log(7 && 'Jonas'); // ikisi de truthy değer o zaman sonuncusu döner.
